...
| Mutation testing (slither-mutate), `GBLIN` and `CowFillAgent` | Partial, stopped at a time cap: 261 mutants caught, 6 not caught by the suite frozen at the start of the campaign, 349 not compiling. The six are listed below | — |
